...
const PortfolioWebsite = ({ theme, setTheme }) => {
  ...
  const getSectionStyle = (sectionId) => ({
    opacity:
      activeSection === sectionId || activeSection === "profile" ? 1 : 0.5,
    transform:
      activeSection === sectionId || activeSection === "profile"
        ? "translateY(0)"
        : "translateY(100px)", // Apply animation from bottom
  ...
  return (
    <div className="website">
      ...
      {validSections.length > 0 &&
        validSections.map(({ id, component }) => (
